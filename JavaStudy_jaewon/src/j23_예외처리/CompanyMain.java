	...
	*/
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("해당 주소에는 객체가 존재하지 않습니다.");
			e.printStackTrace();
			//throw new NullPointerException("해당 주소에는 객체가 존재하지 않습니다.");
		}finally {
